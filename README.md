...
## Usage guide
- Start from the first page. This extension will scrape your entire wordbook; you cannot opt to scrape only a part of it unless you use filtering.
...
- Can export to Quizlet/Knowt or as a CSV

### Note (for Quizlet/Knowt export function ONLY):
- The separator between word and definition is `%`
- The separator between words is `@`
- This function is not customisable
